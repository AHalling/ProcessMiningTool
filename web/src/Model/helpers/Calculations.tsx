import { Coords, UiEvent, Relation } from 'types';


export function calculateArrowUsingAngles(start_event: UiEvent, end_event: UiEvent, relation: Relation) {
